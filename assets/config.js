window.EnergyNestConfig = {
  ...
  // Prices are display values only.
  "PRICING": {
    "singleSession": {
    ...
    "supportedRate": {
      ...
      "slug": "supported-rate",
      "badge": "Limited",
      "note": "A few spots each month, by request.",
      "equity": true
    }
  },
  "schedulerLinks": {
    ...
    "supported-rate": "https://cal.com/REPLACE_WITH_CAL_LINK_SUPPORTED_RATE"
  }
};
